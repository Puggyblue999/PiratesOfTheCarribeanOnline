...
availableHairColors = [
    ...
    7]
hairColors = [
    VBase4(141 / 255.0, 106 / 255.0, 41 / 255.0, 255 / 255.0),
    VBase4(78 / 255.0, 57 / 255.0, 24 / 255.0, 255 / 255.0),
    VBase4(255 / 255.0, 214 / 255.0, 125 / 255.0, 255 / 255.0),
    VBase4(200 / 255.0, 153 / 255.0, 73 / 255.0, 255 / 255.0),
    VBase4(133 / 255.0, 58 / 255.0, 33 / 255.0, 255 / 255.0),
    VBase4(86 / 255.0, 34 / 255.0, 0 / 255.0, 255 / 255.0),
    VBase4(41 / 255.0, 41 / 255.0, 41 / 255.0, 255 / 255.0),
    VBase4(187 / 255.0, 187 / 255.0, 187 / 255.0, 255 / 255.0),
    VBase4(0 / 255.0, 128 / 255.0, 0 / 255.0, 255 / 255.0)]
hatColorsOld = [
    [
    ...
    [
        ...
        VBase4(21 / 255.0, 22 / 255.0, 24 / 255.0, 255 / 255.0)]]
skinColors = [
    VBase4(229 / 255.0, 186 / 255.0, 142 / 255.0, 255 / 255.0),
    VBase4(228 / 255.0, 191 / 255.0, 139 / 255.0, 255 / 255.0),
    VBase4(230 / 255.0, 194 / 255.0, 178 / 255.0, 255 / 255.0),
    VBase4(227 / 255.0, 198 / 255.0, 191 / 255.0, 255 / 255.0),
    VBase4(171 / 255.0, 121 / 255.0, 86 / 255.0, 255 / 255.0),
    VBase4(181 / 255.0, 149 / 255.0, 111 / 255.0, 255 / 255.0),
    VBase4(175 / 255.0, 145 / 255.0, 104 / 255.0, 255 / 255.0),
    VBase4(182 / 255.0, 130 / 255.0, 106 / 255.0, 255 / 255.0),
    VBase4(183 / 255.0, 150 / 255.0, 142 / 255.0, 255 / 255.0),
    VBase4(142 / 255.0, 97 / 255.0, 64 / 255.0, 255 / 255.0),
    VBase4(151 / 255.0, 104 / 255.0, 87 / 255.0, 255 / 255.0),
    VBase4(147 / 255.0, 123 / 255.0, 86 / 255.0, 255 / 255.0),
    VBase4(151 / 255.0, 104 / 255.0, 87 / 255.0, 255 / 255.0),
    VBase4(161 / 255.0, 126 / 255.0, 115 / 255.0, 255 / 255.0),
    VBase4(108 / 255.0, 71 / 255.0, 44 / 255.0, 255 / 255.0),
    VBase4(101 / 255.0, 80 / 255.0, 62 / 255.0, 255 / 255.0),
    VBase4(98 / 255.0, 79 / 255.0, 51 / 255.0, 255 / 255.0),
    VBase4(93 / 255.0, 63 / 255.0, 47 / 255.0, 255 / 255.0),
    VBase4(139 / 255.0, 110 / 255.0, 99 / 255.0, 255 / 255.0),
    VBase4(81 / 255.0, 59 / 255.0, 44 / 255.0, 255 / 255.0)]
crazySkinColors = [
    VBase4(0 / 255.0, 255 / 255.0, 128 / 255.0, 255 / 255.0),
    VBase4(128 / 255.0, 0 / 255.0, 255 / 255.0, 255 / 255.0),
    VBase4(128 / 255.0, 255 / 255.0, 255 / 255.0, 255 / 255.0),
    VBase4(0 / 255.0, 206 / 255.0, 209 / 255.0, 255 / 255.0),
    VBase4(255 / 255.0, 0 / 255.0, 255 / 255.0, 255 / 255.0),
    VBase4(255 / 255.0, 255 / 255.0, 0 / 255.0, 255 / 255.0),
    VBase4(255 / 255.0, 0 / 255.0, 0 / 255.0, 255 / 255.0),
    VBase4(0 / 255.0, 0 / 255.0, 255 / 255.0, 255 / 255.0),
    VBase4(0 / 255.0, 255 / 255.0, 0 / 255.0, 255 / 255.0)]
...
jewelryColors = [
    None,
    VBase4(255 / 255.0, 215 / 255.0, 0 / 255.0, 255 / 255.0),
    VBase4(192 / 255.0, 192 / 255.0, 192 / 255.0, 255 / 255.0),
    VBase4(176 / 255.0, 23 / 255.0, 31 / 255.0, 255 / 255.0),
    VBase4(128 / 255.0, 0 / 255.0, 128 / 255.0, 255 / 255.0),
    VBase4(39 / 255.0, 64 / 255.0, 139 / 255.0, 255 / 255.0),
    VBase4(0 / 255.0, 206 / 255.0, 209 / 255.0, 255 / 255.0),
    VBase4(0 / 255.0, 201 / 255.0, 87 / 255.0, 255 / 255.0),
    VBase4(30 / 255.0, 30 / 255.0, 30 / 255.0, 255 / 255.0)]
clothesTopColorsOld = [
    [
        VBase4(255 / 255.0, 255 / 255.0, 255 / 255.0, 255 / 255.0),
        VBase4(194 / 255.0, 210 / 255.0, 222 / 255.0, 255 / 255.0),
...
class HumanDNA(AvatarDNA.AvatarDNA):
    ...
    def lookupClothesTopColor(self):
        ...
        try:
            return [
                ...
                DYE_COLORS[self.clothes.vestColor],
                DYE_COLORS[self.clothes.coatColor]]
        except:
            return [
                DYE_COLORS[0],
                DYE_COLORS[5],
    ...
    def lookupClothesBotColor(self):
        ...
        try:
            return [
                ...
                DYE_COLORS[self.clothes.sashColor],
                DYE_COLORS[self.clothes.shoeColor]]
        except:
            return [
                DYE_COLORS[0],
                DYE_COLORS[7],
    ...
    def makeNPCPirate(self, seed = None, gender = 'm'):
        ...
        if self.gender == 'm':
            ...
            self.body.color = 0
            self.clothes.shirt = randomGen.choice([
                3,
                4,
                5])
            self.clothes.shirtColor = randomGen.choice(colors)
            self.clothes.pant = randomGen.choice([
                0,
                2])
            self.clothes.pantColor = randomGen.choice(colors)
            self.clothes.sock = 0
            self.clothes.shoe = randomGen.choice([
                1,
                2,
                3,
                4])
    ...
    def makeNPCBountyHunter(self, seed = None, gender = 'm'):
        ...
        if self.gender == 'm':
            ...
            self.clothes.coatColor = randomGen.choice(colors)
            self.head.texture = 0
            self.clothes.hat = randomGen.choice([
                15,
                17,
                18])
            self.head.hair.hair = randomGen.choice([
    ...
    def getCompositeDNA(self):
        ...
        self.body.headSize,
        self.head.headWidth,
        self.head.headHeight,
        self.head.headRoundness,
        self.head.jawWidth,
        self.head.jawRoundness,
        self.head.jawChinSize,
        self.head.jawAngle,
        self.head.jawLength,
        self.head.mouthWidth,
        self.head.mouthLipThickness,
        self.head.mouthFrown,
        self.head.cheekBoneHeight,
        self.head.cheekBoneWidth,
        self.head.cheekFat,
        self.head.browWidth,
        self.head.browProtruding,
        self.head.browAngle,
        self.head.browHeight,
        self.head.eyeCorner,
        self.head.eyeOpeningSize,
        self.head.eyeBulge,
        self.head.noseBridgeWidth,
        self.head.noseNostrilWidth,
        self.head.noseLength,
        self.head.noseBump,
        self.head.noseNostrilHeight,
        self.head.noseNostrilAngle,
        self.head.noseNostrilIndent,
        self.head.noseBridgeBroke,
        self.head.noseNostrilBroke,
        self.head.earScale,
        self.head.earFlapAngle,
        self.head.earPosition,
        self.head.earLobe,
        self.head.texture,
        self.head.hair.hair,
        self.head.hair.beard,
        self.head.hair.mustache,
        self.head.hair.color,
        self.head.hair.highlight,
        self.head.eyes.color,
        self.clothes.hat,
        self.clothes.hatTexture,
        self.clothes.shirt,
        self.clothes.shirtTexture,
        self.clothes.pant,
        self.clothes.pantTexture,
        self.clothes.sock,
        self.clothes.sockTexture,
        self.clothes.shoe,
        self.clothes.shoeTexture,
        self.clothes.vest,
        self.clothes.vestTexture,
        self.clothes.coat,
        self.clothes.coatTexture,
        self.clothes.belt,
        self.clothes.beltTexture,
        self.clothes.shirtColor,
        self.clothes.vestColor,
        self.clothes.coatColor,
        self.clothes.pantColor,
