...
heightBiasArray = {
    'm': BodyDefs.maleHeightBias,
    'f': BodyDefs.femaleHeightBias,
    'n': [
        0.20000000000000001,
        0,
        0,
...
CamInitPosHprs = [
    [
        [
            Vec3(-2.2000000000000002, 17.399999999999999, 8.5),
            Vec3(-2.0 + 180.0, -15.800000000000001, -1.2)],
        [
            Vec3(-2.2000000000000002, 17.399999999999999, 8.5),
            Vec3(-2.0 + 180.0, -15.800000000000001, -1.2)],
        [
...
CamZoomInPosHprs = [
    [
        [
            Vec3(0.0, 3.5, 5.4000000000000004),
            Vec3(-6.2000000000000002 + 180.0, -13.1, -2.3999999999999999)],
        [
            Vec3(0.029999999999999999, 3, 6.2999999999999998),
            Vec3(-5.0 + 180.0, -16.5, -2.1000000000000001)],
        [
            Vec3(0, 4, 7),
            Vec3(-5.0 + 180.0, -16.5, -2.1000000000000001)],
        [
            Vec3(-0.14999999999999999, 3.8999999999999999, 6.2999999999999998),
            Vec3(-3.2999999999999998 + 180.0, -11.1, -1.8999999999999999)],
        [
            Vec3(0.14999999999999999, 4.7000000000000002, 7.5),
            Vec3(-7.2000000000000002 + 180.0, -14.9, -2.7999999999999998)]],
    [
        [
            Vec3(-0.5, 4, 5.2999999999999998),
            Vec3(-6.2000000000000002 + 180.0, -13.1, -2.3999999999999999)],
        [
            Vec3(-0.40000000000000002, 3.2000000000000002, 6),
            Vec3(-6.2000000000000002 + 180.0, -13.1, -2.3999999999999999)],
        [
            Vec3(-0.5, 3.3999999999999999, 6.0999999999999996),
            Vec3(-3.7999999999999998 + 180.0, -9.0999999999999996, -2.6000000000000001)],
        [
            Vec3(-0.59999999999999998, 3.6000000000000001, 6.5),
            Vec3(-3.2999999999999998 + 180.0, -11.1, -1.8999999999999999)],
        [
            Vec3(-0.5, 3.3999999999999999, 6),
            Vec3(-3.7999999999999998 + 180.0, -9.0999999999999996, -2.6000000000000001)]]]
CamZoomOutPosHprs = [
    [
        [
            Vec3(-3, 20.5, 9.1999999999999993),
            Vec3(-0.29999999999999999 + 180.0, -15.699999999999999, -0.80000000000000004)],
        [
            Vec3(-3, 20.5, 9.1999999999999993),
            Vec3(-0.29999999999999999 + 180.0, -15.699999999999999, -0.80000000000000004)],
        [
    ...
    [
        ...
        [
            ...
            Vec3(-0.29999999999999999 + 180.0, -15.699999999999999, -0.80000000000000004)]]]
CATALOG_HOLIDAYS = {
    'Royal Commodore': 3901,
    'Treasure Hunter': 3902,
    'Emerald Duelist': 3903,
    "Town Mayor's Outfit": 3904,
    'Merchant Voyager': 3905,
    'Admiral': 3906,
    'Spanish Conquistador': 3907,
    'Crimson Captain': 3908,
    'Spanish Adventurer': 3909,
    "Raven's Cove Mercenary": 3910,
    'Pilgrim Explorer': 3911,
    'French Fencer': 3912,
    'Oriental': 3913,
    'Capt. Black': 3914 }
...
class MakeAPirate(DirectObject, StateData.StateData, FSM.FSM):
    ...
    def __init__(self, avList, doneEvent, subId = 0, index = 0, isPaid = 0, isNPCEditor = False, piratesEditor = None):
        ...
        self.undoClothing = {
            'm': [
                ItemGlobals.getDefaultMaleClothing()],
            'f': [
                ItemGlobals.getDefaultFemaleClothing()],
            'n': [
                defaultClothing] }
        self.guiIdStates = { }
    ...
    def enter(self):
        ...
        if not self.noJailLight:
            ...
            light = DynamicLight.DynamicLight(type = DynamicLight.DYN_LIGHT_AMBIENT, parent = render, pos = VBase3(37.911999999999999, 12.061, 0.94399999999999995), hpr = VBase3(176.273, 5.6779999999999999, -0.21199999999999999))
            ...
            light.setHpr(newHpr)
            light.turnOff()
            light.setIntensity(0.31819999999999998)
            light.setConeAngle(60.0)
            light.setDropOff(9.5455000000000005)
            light.turnOn()
            light = DynamicLight.DynamicLight(type = DynamicLight.DYN_LIGHT_SPOT, parent = render, pos = VBase3(12.358000000000001, 7.0720000000000001, 12.536), hpr = VBase3(117.392, -35.256, -7.4889999999999999))
            ...
            light.setHpr(newHpr)
            light.turnOff()
            light.setIntensity(0.45450000000000002)
            light.setConeAngle(77.045500000000004)
            light.setDropOff(84.545500000000004)
            light.turnOn()
            light = DynamicLight.DynamicLight(type = DynamicLight.DYN_LIGHT_SPOT, parent = render, pos = VBase3(-9.9139999999999997, 10.93, 14.172000000000001), hpr = VBase3(-137.87700000000001, -34.676000000000002, -4.0259999999999998))
            ...
            light.setConeAngle(78.636399999999995)
            light.setDropOff(87.2727)
            light.turnOn()
            light = DynamicLight.DynamicLight(type = DynamicLight.DYN_LIGHT_SPOT, parent = render, pos = VBase3(7.1559999999999997, -15.566000000000001, 9.9710000000000001), hpr = VBase3(27.413, -20.550999999999998, -68.329999999999998))
            ...
            light.setConeAngle(56.363599999999998)
        ...
        if self.isTutorial:
            self.offsetZoomPos = Vec3(-0.59999999999999998, 4, 1.2)
    ...
    def load(self):
        ...
        self.bookModel.hide()
        self.lowBookModel = DirectFrame(parent = base.a2dBottomLeftNs, relief = None, frameSize = (-1, 1, -0.12, 0.12), frameColor = (0.5, 0.5, 0.5, 0.29999999999999999), borderWidth = (0.025000000000000001, 0.025000000000000001), pos = (0.45000000000000001, 0, 0.12), scale = (0.59999999999999998, 1, 0.75))
        self.lowBookModel.hide()
    ...
    def handleSuperLowLOD(self):
        ...
        if self.skeleton:
            ...
            self.superLowPirate.generateHuman(gender, [
                m,
                m])
